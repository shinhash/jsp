...
public class CustomMyBatisBatchItemWriter<T> implements ItemWriter<List<T>>, InitializingBean {
	...
	/**
	 * Public setter for the flag that determines whether an assertion is made that
	 * all items cause at least one row to be updated.
	 *
	 ...
	 *
	 * @param sqlSessionTemplate a template object for use the {@link SqlSession} on
	 *                           the Spring managed transaction
	 */
