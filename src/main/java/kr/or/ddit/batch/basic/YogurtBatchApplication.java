...
public class YogurtBatchApplication {
	...
	public static void main(String[] args) {
		...
		ApplicationContext context = new ClassPathXmlApplicationContext("classpath:kr/or/ddit/config/spring/yogurt-batch.xml",
		...
		try {
			jobLauncher.run(yogurtJob, new JobParametersBuilder().addParameter("ym", new JobParameter("202011"))
